	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			...
			wp_nav_menu( array(
				...
				'menu_class'        => 'top-menu',
				'container_class' => 'menu-navigation-menu-en-container'
			) );
			?>
		...
		<div class="nav-srch-lang">
			...
			<div class="langMenu">
				...
				$menuName = get_term(get_nav_menu_locations()['language-menu'], 'nav_menu')->name;
				$languages = wp_get_nav_menu_items($menuName, array());
				echo '<div id="langSelect">';
				$currentLang = 'EN';
				if (function_exists('pll_get_post_language')) {
					$currentLang = strtoupper(pll_get_post_language(get_the_ID()));
				}
				echo "<a href='javascript:void(0)'><span>" . $currentLang . "</span> <img src='". get_template_directory_uri() . "/Icons/keyboard_arrow_down-24px.svg'></a>";
				echo '<div class="langOptions">';
				foreach ($languages as $language) {
					echo '<div class="option">';
					echo '<a href="' . $language->url . '">' . $language->title . '</a>';
					echo '</div>';
				}
				echo '</div></div>';
