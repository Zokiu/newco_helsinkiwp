        ...
        <div class="EventContainer ">
            ...
            <div class="bgGrey">
                ...
                <div class="EventCategories">
                    <div class="seeAllButton2"> Verkostoituminen</div>
                    <div class="seeAllButton2"> Startups</div>
                    <div class="seeAllButton2"> Training & Workshops</div>
                </div>
                ...
                <div class="EventCards">
                    <div class="EventCard">
                        ...
                        <div class="Cardcon">
                            <h4>Lorem ipsum</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam debitis, totam odio ad
                                quibusdam dolore
                                dolor</p>
                        </div>
                        <div class="readMore">
                            <a href="#" class="dropbtn bold">Lue lisää
                                <img class="cardArrow" src="/Icons/keyboard_arrow_right-24px.svg"
                    ...
                    <div class="seeAllButton2" id="moreEvents"> Näytä lisää tapahtumia</div>
                </div>
