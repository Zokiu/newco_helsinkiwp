...
<?php if ( have_rows( 'tietoa_meista_content' ) ): ?>
	<?php while ( have_rows( 'tietoa_meista_content' ) ) : the_row(); ?>
        ...
        <div class="contentText">
			...
			<?php if ( have_rows( 'buttons' ) ) : ?>
				<?php while ( have_rows( 'buttons' ) ) : the_row(); ?>
                    ...
                    <?php if ( $link ) { ?>
                        <a class="tietoaMeista_link" href="<?php echo $link['url']; ?>" target="<?php echo $link['target']; ?>"><?php echo $link['title']; ?></a>
                    <?php } ?>
        ...
        <div class="smallQuoteCarousel">
            <?php if ( $title = get_sub_field('title') ): ?>
                <h4 class=""><?php echo esc_html($title); ?></h4>
            <?php endif; ?>
            <div class="slider">
                <?php if ( have_rows( 'quote_carousel_message' ) ) : ?>
                    <?php while ( have_rows( 'quote_carousel_message' ) ) : the_row(); ?>
                    <div class="smallQuoteCarouselMessage">
                      
                        <p class="quoteText_p"><?php the_sub_field( 'message' ); ?></p>
                    </div> 
                    <?php endwhile; ?>
            </div>
			<?php else : ?>
        ...
        <div class="newsContainer">
            ...
            if( $link ):
                ...
                ?><div style="margin: 48px auto; text-align: center;">
